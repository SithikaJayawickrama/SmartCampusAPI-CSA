...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Jackson 1.9 JSON provider — fully compatible with Jersey 1.x / JAX-RS 1.1
        // Handles Map<String,Object>, POJOs, Lists — no JAXB needed
        ...
        // Logging filter (Jersey 1.x native)
